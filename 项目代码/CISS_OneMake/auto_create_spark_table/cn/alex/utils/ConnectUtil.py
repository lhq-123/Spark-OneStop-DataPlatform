...
def getHiveConn():
    ...
    hiveConn = None
    try:
        HIVE_HOST = ConfigUtil.getHiveConfig("hiveHost")
        HIVE_PORT = ConfigUtil.getHiveConfig("hivePort")
        HIVE_USER = ConfigUtil.getHiveConfig("hiveUName")
        HIVE_PASSWORD = ConfigUtil.getHiveConfig("hivePassWord")
