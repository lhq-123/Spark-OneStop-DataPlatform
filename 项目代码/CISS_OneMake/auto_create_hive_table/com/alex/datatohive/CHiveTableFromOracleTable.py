...
from auto_create_hive_table.com.alex.datatohive import CreateMetaCommon        # 导入常量数据包
from auto_create_hive_table.com.alex.utils import OracleMetaUtil               # 导入Oracle表信息的工具类
