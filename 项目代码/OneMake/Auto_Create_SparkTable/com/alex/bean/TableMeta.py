...
# Author: Alex_liu
# Program function:  表对应元数据对象
from Auto_Create_SparkTable.com.alex.bean.ColumnMeta import ColumnMeta
...
class TableMeta(object):
    ...
    def __init__(self, tableName, tableComment):
        self._tableName = tableName                     # 表名属性
        self._tableComment = tableComment               # 表注释
        self._columnMetaList: [ColumnMeta] = list()     # 列的信息List【每一列的信息】
