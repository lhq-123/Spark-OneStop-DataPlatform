...
# Author: Alex_Liu
# Program function:  用于读取Oracle中表的信息【表名、列的信息、表的注释】封装成TableMeta

import logging
import cx_Oracle
# 列的信息对象
from Auto_Create_SparkTable.com.alex.bean.TableMeta import ColumnMeta
# 表的信息对象
from Auto_Create_SparkTable.com.alex.bean.TableMeta  import TableMeta
